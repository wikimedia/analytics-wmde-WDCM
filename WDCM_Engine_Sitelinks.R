...
### ---------------------------------------------------------------------------
### --- WDCM Engine (S)itelinks, v. Beta 0.1
### --- Script: WDCM_Engine_Sitelinks.R, v. Beta 0.1
...
system(command = 'cp /home/goransm/RScripts/WDCM_R/WDCM_SiteLinksData/wikipediaSitelinksUpdateString.txt /srv/published-datasets/wdcm/WDCM_Sitelinks/', 
       wait = T)
